...
function ApprAndArchVehicles({
  ...
  const archive = (id) => {
    if (sale) {
      customArchive(id, "admin-archive-vehicle-for-sale");
    } else if (rent) {
      customArchive(id, "admin-archive-vehicle-for-rent");
    }
  };
  const deleteListing = (id) => {
    if (sale) {
      customDeleteListing(id, "admin-delete-vehicle-for-sale");
    } else if (rent) {
      customDeleteListing(id, "admin-delete-vehicle-for-rent");
    }
  };
...
export default ApprAndArchVehicles;
